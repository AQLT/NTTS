...
\includegraphics[width=2cm]{img/jdemetra+.jpg} TRAMO/SEATS+ and X-13ARIMA-SEATS are implemented in JDemetra+
...
### Seasonal adjustment examples (3/7): decomposition
...
### Seasonal adjustment examples (4/7): decomposition
...
### Seasonal adjustment examples (8/7)
...
# How to use JDemetra+ to improve production of SA series?
